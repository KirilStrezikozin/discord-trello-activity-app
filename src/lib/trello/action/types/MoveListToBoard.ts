...
export default class ActionMoveListToBoard extends BoardAndListCardsActionBase {
  public static override readonly schema = z.object({
    id: z.string().min(1),
    type: z.literal("moveListToBoard"),
  ...
  protected override data?: z.infer<typeof ActionMoveListToBoard.schema>;
  ...
  protected override buildMessageInner(
    ...
    const name = opts.member
      ? `${opts.member?.username} has brought a list from an external board`
      : "A list has been brought from an external board";
