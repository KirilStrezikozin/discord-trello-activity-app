...
export default class ActionUnsetAttachmentAsCardCover extends AttachmentActionBase {
  ...
  protected override data?: z.infer<typeof ActionUnsetAttachmentAsCardCover.schema>
  ...
  protected override getAttachmentId(): string {
    return this.data!.data.old.idAttachmentCover;
  }
  ...
  protected override buildMessageInner(
    ...
    const name = opts.member
      ? `${opts.member?.username} has unset an attachment as a card cover`
      : "An attachment has been unset as a card cover";
