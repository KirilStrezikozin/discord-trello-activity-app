...
export default class ActionMovedListLeft extends Action {
  ...
  protected override data?: z.infer<typeof ActionMovedListLeft.schema>;

  protected override buildMessageInner(
    embed: EmbedBuilder, opts: MessageOptions
  ): EmbedBuilder {
    const name = opts.member
      ? `${opts.member?.username} has moved a list left in a board`
      : "A list has been moved left in a board";
