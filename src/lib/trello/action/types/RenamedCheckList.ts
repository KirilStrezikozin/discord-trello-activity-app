...
export default class ActionRenamedCheckList extends CheckListActionBase {
  ...
  protected override data?: z.infer<typeof ActionRenamedCheckList.schema>;

  protected override buildMessageInner(
    embed: EmbedBuilder, opts: MessageOptions
  ): EmbedBuilder {
    const name = opts.member
      ? `${opts.member?.username} has renamed a checklist in a card`
      : "A checklist has been renamed in a card";
