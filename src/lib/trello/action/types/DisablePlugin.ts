...
export default class ActionDisablePlugin extends Action {
  public static override readonly schema = z.object({
    id: z.string().min(1),
    type: z.literal("disablePlugin"),
  ...
  protected override data?: z.infer<typeof ActionDisablePlugin.schema>;

  protected override buildMessageInner(
    embed: EmbedBuilder, opts: MessageOptions
  ): EmbedBuilder {
    const name = opts.member
      ? `${opts.member?.username} has disabled a plugin`
