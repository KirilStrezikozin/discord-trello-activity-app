...
export default class ActionRenamedBoard extends Action {
  ...
  protected override data?: z.infer<typeof ActionRenamedBoard.schema>;

  protected override buildMessageInner(
    embed: EmbedBuilder, opts: MessageOptions
  ): EmbedBuilder {
    const name = opts.member
      ? `${opts.member?.username} has renamed a board`
      : "A board has been renamed";
