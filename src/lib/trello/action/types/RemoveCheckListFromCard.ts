...
export default class ActionRemoveCheckListFromCard extends CheckListActionBase {
  ...
  protected override data?: z.infer<typeof ActionRemoveCheckListFromCard.schema>;
