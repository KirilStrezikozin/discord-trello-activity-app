...
export default class ActionCreateList extends Action {
  ...
  protected override data?: z.infer<typeof ActionCreateList.schema>;

  protected override buildMessageInner(
    embed: EmbedBuilder, opts: MessageOptions
  ): EmbedBuilder {
    const name = opts.member
      ? `${opts.member?.username} has created a new list`
